...
function BenefitItem({ srcLight, srcDark, title, text }: BenefitItemProps) {
  return (
    <div className="bg-linear-to-br from-primary-0/10 to-primary-0/15 backdrop-blur-2 rounded-2xl border border-primary-0/20 p-2 flex gap-3">
      <ThemeImage
        srcLight={srcLight}
        srcDark={srcDark}
        alt="decor"
    ...
    <section className="max-w-360 lg:px-28 lg:mx-auto">
      <div className="bg-accent-600 pt-8 pb-14 px-8 my-14 md:rounded-4xl md:p-14 md:my-20 md:mx-8 lg:max-w-301 lg:mx-auto flex flex-col gap-10 lg:flex-row relative overflow-hidden">
        ...
        <div className="flex-1 relative z-10">
          <h2 className="font-DM font-bold text-4xl mb-10 md:text-5xl text-primary-0">{title}</h2>
          <button className="font-DM font-bold text-base text-primary-0 bg-linear-to-br from-primary-0/10 to-primary-0/25 backdrop-blur-2 rounded-xl py-4 px-8 w-full md:w-auto flex gap-2 justify-center">
